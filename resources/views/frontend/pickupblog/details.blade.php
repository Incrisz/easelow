...
@section('meta')
    ...
    <meta property="og:url" content="{{ route('pickupblog.details', $blog->slug) }}" />
        ...
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="bg-white rounded shadow-sm p-4"> 
                    ...
                    <div>
                        <div class="fb-comments" data-href="{{ route("pickupblog",$blog->slug) }}" data-width="" data-numposts="5"></div>
                    </div>
                    @endif
                </div>
            </div>
