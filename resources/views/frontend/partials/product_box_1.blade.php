...
<div class="aiz-card-box h-auto bg-white py-3 hov-scale-img">
    <div class="position-relative h-140px h-md-200px img-fit overflow-hidden">
        ...
        @endif
               ...
               <!-- School -->
               @if ($product->brand)
<span class="absolute-top-left   fs-11 fw-700 text-white w-55px text-center" style="background-color: red; @if(discount_in_percentage($product) > 0) left:45px; @endif">{{ $product->brand['name'] }}</span>
@endif
