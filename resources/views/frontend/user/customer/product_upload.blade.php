    ...
    <form class="" action="{{route('customer_products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
        ...
        <div class="card rounded-0 shadow-none border">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-from-label">{{translate('Product School')}} <span class="text-danger">*</span></label>
                    <div class="col-md-10">
                        <select class="form-control aiz-selectpicker" data-placeholder="{{ translate('Select a School')}}" data-live-search="true"  id="brands" name="brand_id">
                            <option value=""></option>
