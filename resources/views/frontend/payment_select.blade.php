            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="row gutters-5 sm-gutters-10">
                        ...
                        <div class="col done">
                            <div class="text-center border border-bottom-6px p-2 text-success">c
                    ...
                    <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST"
                        ...
                        <div class="card rounded-0 border shadow-none">
                            ...
                            <div class="card-body text-center px-4 pt-0">
                                <div class="row gutters-10">
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4" >
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    ...
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('Pay With Paystack') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
                                    ...
                                    @if (Auth::check())
                                        ...
                                        @if (addon_is_activated('offline_payment'))
                                            ...
                                            @foreach (\App\Models\ManualPaymentMethod::all() as $method)
                                                <div id="manual_payment_info_{{ $method->id }}" class="d-none" style="display:none">
                                ...
                                @if (addon_is_activated('offline_payment'))
                                    <div class="d-none mb-3 rounded border bg-white p-3 text-left" style="display:none">
                                ...
                                @if (Auth::check() && get_setting('wallet_system') == 1)
                                    <div class="py-4 px-4 text-center bg-soft-warning mt-4">
                                        <div class="fs-14 mb-3">
                                              <span class="opacity-80">{{ translate('OR, Pay From wallet ') }}</span> <br>
