        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Add Multiple Images')}}</label>
                    <div class="col-lg-8">
                        <div id="photos">
                ...
                {{-- <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Main Image')}}
                <small>(290x300)</small></label>
                <div class="col-lg-8">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row" style="display:none;">
                ...
                <div class="col-md-9">
                    <input type="text" placeholder="{{ translate('e.g. 0901223445') }}" name="external_link" value="{{ $product->external_link }}" class="form-control">
